...
void CoupledPressureSaturationProblem<dim>::output_vtk_initial_cond() const
{
	...
	const std::string filename_pl_0 =
		        "OUTPUT_Q5S_3D_SMALL_STAB/solution_pl-000.vtu";
	...
	const std::string filename_pl_1 =
		        "OUTPUT_Q5S_3D_SMALL_STAB/solution_pl-001.vtu";
	...
	const std::string filename_Sa_0 =
				"OUTPUT_Q5S_3D_SMALL_STAB/solution_Sa-000.vtu";
	...
	const std::string filename_Sa_1 =
				"OUTPUT_Q5S_3D_SMALL_STAB/solution_Sa-001.vtu";
	...
	if(!two_phase)
	{
		...
		const std::string filename_Sv_0 =
					"OUTPUT_Q5S_3D_SMALL_STAB/solution_Sv-000.vtu";
		...
		const std::string filename_Sv_1 =
					"OUTPUT_Q5S_3D_SMALL_STAB/solution_Sv-001.vtu";
...
void CoupledPressureSaturationProblem<dim>::output_vtk() const
{
	...
	const std::string filename_pl =
		        "OUTPUT_Q5S_3D_SMALL_STAB/solution_pl-" + Utilities::int_to_string(timestep_number, 3) + ".vtu";
	...
	const std::string filename_Sa =
			"OUTPUT_Q5S_3D_SMALL_STAB/solution_Sa-" + Utilities::int_to_string(timestep_number, 3) + ".vtu";
	...
	if(!two_phase)
	{
		...
		const std::string filename_Sv =
				"OUTPUT_Q5S_3D_SMALL_STAB/solution_Sv-" + Utilities::int_to_string(timestep_number, 3) + ".vtu";
